...
class CommandContext:
    ...
    Uses typing.Any for circular-import-prone types (LukawiApp, ReActAgent, etc.)
    to keep this module dependency-free.
    """

    app: Any
    """Reference to the LukawiApp instance (typing.Any to avoid circular imports)."""
    ...
    """ChatContainer widget for displaying command output."""
